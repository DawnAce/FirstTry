...
- 步骤：4 期月份将第 1、2 期登记为每月两次合寄并在第 2 期完成一张运单，第 3、4 期在第 4 期完成第二张；5 期月份按第 1+2 期和第 3+4+5 期完成两张；月底合寄客户将当月全部期次在最后一期完成一张。
- 预期：工作台分别统计“待每月两次合寄”和“待月底合寄”；合寄待办显示正确的目标刊期和目标日期；4 期月形成 2+2、5 期月形成 2+3、月底合寄形成 4 或 5 期一批；一张实际运单按份数分摊到各来源刊期，完成前不计实际发出，完成后各期核销均归零。
