...
- 步骤：进入运单核对工作台，检查默认页签、计划缺口计数、明细行和顶部“未解释待补”。
- 预期：导入行无待处理时默认打开「计划缺口待归因」；页签和提示均显示 24 份，19 条明细完整可选，不得因 72 份库存入库已反映在逐明细差额后又被重复扣减成 0；月底建议显示金色「待确认」和蓝色「月底合寄」，登记后显示蓝色「月底合寄」与独立的「已登记 · N份」。
