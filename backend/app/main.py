...
from app.api.order_sources import router as order_sources_router
...
app.include_router(order_sources_router, dependencies=[Depends(require_mutation_permission)])
